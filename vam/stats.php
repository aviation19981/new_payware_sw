		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="container">
					...
					<header class="major">
						<h2><?php echo AVIANCA_STATS_CHECK; ?></h2>
						<p><?php echo AVIANCA_STATS_CHECK_INFO; ?> <?php echo date("Y");?></p>
					</header>
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_NUMBER_FLIGTH_CURRENT_MONTH; ?></h3>
			</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_NUMBER_FLIGTH_PER_MONTH_CURRENT_YEAR; ?></h3>
			</div>
			<div class="panel-body">
...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo PILOT_STATS_PERC_DURATION; ?></h3>
			</div>
			<div class="panel-body">
		...
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo VAMACARS_LANDANALYSIS; ?></h3>
			</div>
			<div class="panel-body">
		...
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo PILOT_STATS_COUNTRY; ?></h3>
			</div>
			<div class="panel-body">
...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_PERCENTAGE_BY_AIRCRAFT_TYPE; ?></h3>
			</div>
			<div class="panel-body">
		...
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_PERCENTAGE_REG_VS_CHARTER ; ?></h3>
			</div>
			<div class="panel-body">
		...
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_PERCENTAGE_BY_REPORT_TYPE; ?></h3>
			</div>
			<div class="panel-body">
				...
				<script>
					  ...
					  element: 'perc_reg',
					  data: [<?php
					    	echo '{label: "AVIANCA ACARS", value: '.$percvamacars.'},';
...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_TOP5_HOUR; ?></h3>
			</div>
			<div class="panel-body">
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_TOP5_FLIGTH; ?></h3>
			</div>
			<div class="panel-body">
...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_TOP5_LANDING; ?></h3>
			</div>
			<div class="panel-body">
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_TOP5_ROUTES; ?></h3>
			</div>
			<div class="panel-body">
...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_FLIGHTS_AIRCRAFT_TYPE; ?></h3>
			</div>
			<div class="panel-body">
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_TOP5_AIRCRAFTS; ?></h3>
			</div>
			<div class="panel-body">
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_PILOT_HOURS_YEAR_MONTH; ?></h3>
			</div>
			<div class="panel-body">
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo STATISTICS_PILOT_FLIGHTS_YEAR_MONTH; ?></h3>
			</div>
			<div class="panel-body">
