...
///////////////////// Avianca New Information
define ('AVIANCA_HOME', 'Home');
define ('AVIANCA_ABOUT', 'About Us');
define ('AVIANCA_MGO', 'MGO');
define ('AVIANCA_PCA', 'Pilots');
define ('AVIANCA_STATS', 'Statistics');
define ('AVIANCA_ONLINE', 'Online');
define ('AVIANCA_JOIN', 'Join');
define ('AVIANCA_LOGIN', 'Login');
define ('AVIANCA_SYSTEM', 'System');
define ('AVIANCA_WELCOME', 'Hello! We are Avianca Virtual');
define ('AVIANCA_LEGAL', 'A non-profit organization, unrelated to Avianca Holdings S.A.S');
define ('AVIANCA_MEET_US', 'Get to know us!');
define ('AVIANCA_OFFERED', 'What do we offer?');
define ('AVIANCA_OFFERED_INFO', 'Avianca virtual, offers a modern platform in favor of Avianca´s virtual operations, as real as possible!');
define ('AVIANCA_STATS_INFO', 'Know your financial returns and your statistics about your operations.');
define ('AVIANCA_PIREP_INFO', 'Detail to the maximum of the flights made, with financial information and more.');
define ('AVIANCA_TRAINING', 'Training');
define ('AVIANCA_TRAINING_INFO', 'We empower your abilities so that you give your highest performance.');
define ('AVIANCA_DETAIL', 'Details');
define ('AVIANCA_DETAIL_INFO', 'Relevance in our operations!');
define ('AVIANCA_NEW_PILOTS', 'New Pilots');
define ('AVIANCA_TITLE', 'Certificate');
define ('AVIANCA_TALK', 'Contact Us');


////////////////////////////// Avianca INFORMATION ABOUT US
define ('AVIANCA_ABOUT_US', 'About Us');
define ('AVIANCA_ABOUT_US_INFO', 'Know the potential of this airline!');
define ('AVIANCA_MISSION', 'Mission');
define ('AVIANCA_MISSION_INFO', 'Contribute to the professional and recreational development of virtual simulation networks, offering an atmosphere of harmony among all members of Avianca Virtual and other airlines affiliated with organizations, with emphasis on maintaining a high standard of professionalism.');
define ('AVIANCA_VISSION', 'Vision');
define ('AVIANCA_VISSION_INFO', 'In 2022 we will be a virtual airline recognized worldwide by virtual organizations, as one of the best in the field of professionalism and dedication of our pilots.');
define ('AVIANCA_AIM', 'General Objective');
define ('AVIANCA_AIM_INFO', 'Provide at all times an environment of friendship, companionship and harmony, promoting learning among our pilots, without leaving behind the good management of virtual networks and in turn contribute to the development of these.');
define ('AVIANCA_AIM_LOT', 'Specific Objectives');
define ('AVIANCA_ONE', 'Promote virtual learning among our pilots.');
define ('AVIANCA_TWO', 'Support and help our pilots achieve their goals at the level of knowledge.');
define ('AVIANCA_THREE', 'Instruct the pilots to fly the available aircraft professionally.');
define ('AVIANCA_FOUR', 'Reach the level of the other virtual airlines of the Colombian division.');
define ('AVIANCA_STAFF', 'In detail our representatives!');
define ('AVIANCA_PRESIDENT', 'President');
define ('AVIANCA_OPERATION', 'Operations Director');
define ('AVIANCA_RRHH', 'Director of Human Resources');
define ('AVIANCA_OPR_CHECK', 'Operations Analyst');
define ('AVIANCA_LONG', 'Promoting quality in virtual simulation!');


////////////////////////////// Avianca MGO
define ('AVIANCA_MGO_CHECK', 'Our general operations manual!');

////////////////////////////// Avianca PILOTS
define ('AVIANCA_PCA_CHECK', 'Pilots');
define ('AVIANCA_PCA_CHECK_INFO', 'Information about our pilots');


/////////////////////////////// Avianca STATS
define ('AVIANCA_STATS_CHECK', 'Statistics');
define ('AVIANCA_STATS_CHECK_INFO', 'Know our performance in the');

/////////////////////////////// Avianca LOGIN
define ('AVIANCA_LOGIN_FORM', 'Start Session');
define ('AVIANCA_LOGIN_FORM_INFO', 'Live new experiences with us!');
define ('AVIANCA_LOGIN_ONE', 'Callsign');
define ('AVIANCA_LOGIN_TWO', 'Password');
define ('AVIANCA_LOGIN_THIRD', 'Remember Password');



//////////////////////////////// Avianca INTRANET OPTIONS
define ('AVIANCA_WELCOME_INTRO', 'Welcome!');
define ('AVIANCA_WELCOME_INTRO_INFO', 'Are you ready to fly? Reserve!');


//////////////////////////////// Avianca INTRANET WELCOME
define ('AVIANCA_HELLO', 'Hello!');
define ('AVIANCA_HELLO_INFO', 'What are you waiting to fly with Avianca?');
