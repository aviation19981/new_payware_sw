<?php
    ...
    ///////////////////// Avianca New Information INTRO
	define ('AVIANCA_HOME' , 'Inicio');
	define ('AVIANCA_ABOUT' , 'Nosotros');
	define ('AVIANCA_MGO' , 'MGO');
	define ('AVIANCA_PCA' , 'Pilotos');
	define ('AVIANCA_STATS' , 'Estadísticas');
	define ('AVIANCA_ONLINE' , 'En línea');
	define ('AVIANCA_JOIN' , 'Únete');
	define ('AVIANCA_LOGIN' , 'Iniciar Sesión');
	define ('AVIANCA_SYSTEM' , 'Sistema');
	define ('AVIANCA_WELCOME' , 'Hola! Somos Avianca Virtual');
	define ('AVIANCA_LEGAL' , 'Una organización sin ánimo de lucro, sin relación con Avianca Holdings S.A.S');
	define ('AVIANCA_MEET_US' , 'Conócenos!');
	define ('AVIANCA_OFFERED' , '¿Qué Ofrecemos?');
	define ('AVIANCA_OFFERED_INFO' , 'Avianca virtual, ofrece una plataforma moderna en pro de las operaciones virtuales de Avianca, tan reales como sea posible!');
	define ('AVIANCA_STATS_INFO' , 'Conóce tus rendimientos financieros y tus estadísticas acerca de tus operaciones.');
	define ('AVIANCA_PIREP_INFO' , 'Detalle al máximo de los vuelos realizados, con información financiera y más.');
	define ('AVIANCA_TRAINING' , 'Entrenamiento');
	define ('AVIANCA_TRAINING_INFO' , 'Potenciamos tus capacidades para que des tu mayor rendimiento.');
	define ('AVIANCA_DETAIL' , 'Detalles');
	define ('AVIANCA_DETAIL_INFO' , 'Relevancia en nuestras operaciones!');
	define ('AVIANCA_NEW_PILOTS' , 'Nuevos Pilotos');
	define ('AVIANCA_TITLE' , 'Certificado');
	define ('AVIANCA_TALK' , 'Contáctenos');
	
	////////////////////////////// Avianca INFORMATION ABOUT US
	define ('AVIANCA_ABOUT_US' , 'Acerca de Nosotros');
	define ('AVIANCA_ABOUT_US_INFO' , 'Conóce el potencial de esta aerolínea!');
	define ('AVIANCA_MISSION' , 'Misión');
	define ('AVIANCA_MISSION_INFO' , 'Contribuir con el desarrollo de manera profesional y lúdica de las redes de simulación virtual, ofreciendo un ambiente de armonía entre todos los miembros de Avianca Virtual y demás aerolíneas adscritas a organizaciones, con énfasis en mantener un alto estándar de profesionalismo.');
	define ('AVIANCA_VISSION' , 'Visión');
	define ('AVIANCA_VISSION_INFO' , 'En el 2022 seremos una aerolínea virtual reconocida a nivel mundial por las organizaciones virtuales, como una de las mejores en ámbito de profesionalismo y dedicación de nuestros pilotos.');
	define ('AVIANCA_AIM' , 'Objetivo General');
	define ('AVIANCA_AIM_INFO' , 'Brindar en todo momento un ambiente de amistad, compañerismo y armonía; promoviendo el aprendizaje entre nuestros pilotos, sin dejar atrás el buen manejo de las redes virtuales y a su vez contribuir al desarrollo de estas.');
	define ('AVIANCA_AIM_LOT' , 'Objetivos Específicos');
	define ('AVIANCA_ONE' , 'Promover entre nuestros pilotos el aprendizaje en el ámbito virtual.');
	define ('AVIANCA_TWO' , 'Apoyar y contribuir a que nuestros pilotos alcancen sus metas a nivel de conocimiento.');
	define ('AVIANCA_THREE' , 'Instruir a los pilotos a que vuelen de manera profesional las aeronaves disponibles.');
	define ('AVIANCA_FOUR' , 'Alcanzar el nivel de las otras aerolíneas virtuales de la división colombiana.');
	define ('AVIANCA_STAFF' , 'Al detalle nuestros representantes!');
	define ('AVIANCA_PRESIDENT' , 'Presidente');
	define ('AVIANCA_OPERATION' , 'Director de Operaciones');
	define ('AVIANCA_RRHH' , 'Director Recursos Humanos');
	define ('AVIANCA_OPR_CHECK' , 'Analista de Operaciones');
	define ('AVIANCA_LONG' , 'Promoviendo la calidad en la simulación virtual!');
	
	////////////////////////////// Avianca MGO
	define ('AVIANCA_MGO_CHECK' , 'Nuestro manual general de operaciones!');
	
	////////////////////////////// Avianca PILOTS
	define ('AVIANCA_PCA_CHECK' , 'Pilotos');
	define ('AVIANCA_PCA_CHECK_INFO' , 'Información acerca de nuestros pilotos');
	
	
	/////////////////////////////// Avianca STATS
	define ('AVIANCA_STATS_CHECK' , 'Estadísticas');
	define ('AVIANCA_STATS_CHECK_INFO' , 'Conóce nuestro desempeño en el');
	
	/////////////////////////////// Avianca LOGIN
	define ('AVIANCA_LOGIN_FORM' , 'Inicio Sesión');
	define ('AVIANCA_LOGIN_FORM_INFO' , 'Vive nuevas experiencias con nosotros!');
	define ('AVIANCA_LOGIN_ONE' , 'Callsign');
	define ('AVIANCA_LOGIN_TWO' , 'Password');
	define ('AVIANCA_LOGIN_THIRD' , 'Recordar Contraseña');
	
	
	//////////////////////////////// Avianca INTRANET OPTIONS
	define ('AVIANCA_WELCOME_INTRO' , 'Bienvenido!');
	define ('AVIANCA_WELCOME_INTRO_INFO' , '¿Estás listo para volar? Reserva!');
	
	
	//////////////////////////////// Avianca INTRANET WELCOME
	define ('AVIANCA_HELLO' , 'Hola!');
	define ('AVIANCA_HELLO_INFO' , '¿Qué estás esperando para volar con Avianca?');
	define ('AVIANCA_INFO_INTRANET' , 'Información Avianca Virtual');
