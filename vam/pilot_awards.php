...
<?php
	$NUMCELLS = 5;
	$sql="select * from award_pilots ap INNER JOIN awards a where ap.award_id = a.award_id and gvauser_id=$id order by award_date";
		...
		<div class="card-inner"  style="width:100%;">			
			<div class="card-group"  style="width:100%;">				
				<div class="card-front"  style="width:100%;">
					...
					<div class="info">
						<p class="name"><?php echo PILOT_AWARDS; ?>
						</p>
					</div>
					<article>
					...
					<table class="altern">
						<?php
							...
							if($count==0) {
								...
								echo '<tr><td colspan="2"><a  class="button" style="width:100%;">No Awards</a></td></tr>';
							} else {
