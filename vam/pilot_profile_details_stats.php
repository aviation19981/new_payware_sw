...
<div class="row">
	<div class="col-md-3">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_person_white_18dp_1x.png">&nbsp;<?php echo PILOT_PROFILE; ?></h3>
			</div>
	...
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color: #ae0200;">
				<h3 class="panel-title" style="color: #FFFFFF;"><IMG src="images/icons/ic_equalizer_white_18dp_1x.png">&nbsp;<?php echo PILOT_STATICS; ?></h3>
			</div>
			<div class="panel-body">
				<table class="table table-hover">
					<tr>
