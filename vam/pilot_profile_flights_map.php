...
.card-group .card-front .card-covercuatro {width:100%; height:120px; background:url('./images/portada/<?php echo rand(0,5) ; ?>.jpg') no-repeat 50% 50%; background-size:cover;}
		...
		<div class="card-inner"  style="width:100%;">			
			<div class="card-group"  style="width:100%;">				
				<div class="card-front"  style="width:100%;">
					<div class="card-covercuatro"  style="width:100%;"></div>
					<div class="my-profile"  style="width:100%;">
						<span class="thumb"><img src="./images/logito.png" alt="" /></span>
					</div>
					<div class="info">
						<p class="name"><?php echo PILOT_FLIGTH_MAP; ?></p>
					</div>
					<center><?php include 'pilot_flights_map.php'; ?></center>
				</div>
				<!-- //front -->
			</div>
			<!-- //card-group -->			
